...
while {true} do
{
    ...
    _vitals ctrlSetStructuredText parseText format ["%1 <img size='1.5' image='icons\health.paa'/><br/>%2 <img size='1.5' image='icons\money.paa'/><br/>%3 <img size='1.5' image='icons\water.paa'/>", _health, (player getVariable "mymoney"), thirstLevel];
